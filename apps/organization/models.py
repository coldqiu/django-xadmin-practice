...
class CityDict(models.Model):
    ...
    desc = models.CharField(max_length=200, verbose_name=u"城市简介")
...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, default="", verbose_name="机构类别", choices=(("pxjg", "培训机构"), ("gr","个人"), ("gx","高校")))
...
class Teacher(models.Model):
    ...
    image = models.ImageField(upload_to="courses/%Y/%m", verbose_name=u"教师头像", null=True, blank=True)
